...
export const editorialData = {
  speedTests: {
    "NURO光": {
      down: 897, up: 540, unit: "Mbps",
      testedAt: "2026年4月",
      env: "戸建て2階建て・Wi-Fi 6ルーター使用・平日20時計測",
    },
    "auひかり": {
      down: 743, up: 412, unit: "Mbps",
      testedAt: "2026年4月",
      env: "マンション6階・有線LAN接続・平日21時計測",
    },
    "ドコモ光": {
      down: 612, up: 380, unit: "Mbps",
      testedAt: "2026年4月",
      env: "マンション3階・Wi-Fi 5ルーター使用・平日19時計測",
    },
    "ソフトバンク光": {
      down: 580, up: 310, unit: "Mbps",
      testedAt: "2026年4月",
      env: "戸建て1階・有線LAN接続・平日22時計測",
    },
    "フレッツ光": {
      down: 520, up: 290, unit: "Mbps",
      testedAt: "2026年4月",
      env: "マンション5階・OCNプロバイダ・Wi-Fi 6使用",
    },
    "Biglobe光": {
      down: 490, up: 260, unit: "Mbps",
      testedAt: "2026年4月",
      env: "戸建て1階・有線LAN接続・平日20時計測",
    },
  },
  experiences: {
    "NURO光": "編集部が実際に申し込んだところ、申し込みから開通まで14日間でした。工事は午前中に2時間ほどで完了し、作業員の対応も丁寧でした。開通直後から速度が安定しており、動画視聴やオンラインゲームで遅延を感じたことはありません。",
    "auひかり": "auスマホとのセット割を実際に確認したところ、毎月1,100円の割引が正確に適用されていました。申し込みから開通まで約10日間と比較的スムーズでした。",
    "ドコモ光": "申し込み時のdポイント付与は、開通後2〜3ヶ月後に付与される仕組みでした。問い合わせ対応は電話・チャット共に対応が丁寧で、初心者にも安心して使えます。",
    "工事全般": "光回線の工事は大きく分けて「屋外工事」と「屋内工事」の2段階。マンションの場合、管理組合の許可が必要なケースがあるため、申し込み前に確認が必要です。編集部が確認した中では、申し込みから最短5日で開通したケースもありました。",
    "解約手続き": "解約の申し込みはほぼすべての事業者で電話のみ対応。平日昼間に時間を確保する必要があります。違約金は契約期間中の解約で発生し、2年契約の場合は1〜2万円程度が相場です。",
  },
};
...
export const rankingItems: RankingItem[] = [
  ...
  },
  {
    ...
    reward: { label: "キャッシュバック", value: "最大50,000円" },
